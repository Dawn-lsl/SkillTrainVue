...
export const constantRoutes = [
  ...
  },
  {
    ...
    meta:{title:'系统管理',elSvgIcon: 'Monitor' },
    alwaysShow:true,
    children: [
      {
        path: 'index',
  ...
  },
  {
    ...
    meta:{title:'信息管理',elSvgIcon: 'Management' },
    alwaysShow:true,
    children: [
      {
        path: 'index',
  ...
  },
  {
    ...
    meta:{title:'课程管理',elSvgIcon: 'Notebook' },
    alwaysShow:true,
    children: [
      {
        path: 'index',
      ...
      },
      {
        path: 'task/:courseId',
        name: 'Task',
        component: () => import('@/views/course/task.vue'),
        hidden: true,
        meta: { title: '章节信息' }
      }
    ]
  },
  {
    ...
    component: Layout,
    redirect: '/studyRecord/index',
    meta:{title:'学习监管',elSvgIcon: 'EditPen' },
    alwaysShow:true,
    children: [
      {
        path: 'index',
        component: () => import('@/views/study-record/index.vue'),
        //using el svg icon, the elSvgIcon first when at the same time using elSvgIcon and icon
        meta: { title: '学生学习情况' }
      },
    ]
    ...
    children: [
      {
        ...
        //using el svg icon, the elSvgIcon first when at the same time using elSvgIcon and icon
        meta: { title: 'Element-Puls', elSvgIcon: 'Fold' }
      }
    ]
  },
  // {
