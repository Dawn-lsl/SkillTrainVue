<template>
  <div class="scroll-y">
    ...
    <TextEditor :default-val="'123'" @changeVal="val=>textEditor=val" />
      {{textEditor}}
    <Video :resourceURL="'https://cdn.jsdelivr.net/gh/xdlumia/files/video-play/IronMan.mp4'"/>
  </div>
</template>

<script setup>
import Tinymce from '@/components/Tinymce/Tinymce.vue';
import TextEditor from '@/components/TextEditor/wangEditor.vue'
...
const content = ref('<p>qweqweqwe</p>')
</script>
